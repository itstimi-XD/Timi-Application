...
import com.love.timi.service.v1.AuthService
...
@RestController
@RequestMapping("/user-auth/api/v1/auth")
...
//    }
    ...
    fun getMenuTree(): ResponseEntity<RestResponse<List<MenuTb>>> {
        return RestResponse<List<MenuTb>>().ok().setBody(authService.getMenuTree()).responseEntity()
    }
